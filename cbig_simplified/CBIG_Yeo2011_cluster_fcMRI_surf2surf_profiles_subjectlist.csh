...
foreach s ($subjects)
	if( $scrub_flag == 0 ) then
		...
		echo "!!!!!!!!!!!!! ${sub_dir}/$s/surf2surf_profiles/lh.${s}_${mesh}_roi${roi}.surf2surf_profile_1.nii.gz"
		echo "${sub_dir}/$s/surf2surf_profiles/lh.${s}_${mesh}_roi${roi}.surf2surf_profile_1.nii.gz" >> $lh_profile_input
		echo "${sub_dir}/$s/surf2surf_profiles/rh.${s}_${mesh}_roi${roi}.surf2surf_profile_1.nii.gz" >> $rh_profile_input
	else
